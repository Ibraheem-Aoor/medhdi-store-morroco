...
use App\Http\Controllers\Admin\Addon\AddonController;
use App\Http\Controllers\Admin\AdminController;
use App\Http\Controllers\AizUploadController;
use App\Http\Controllers\Admin\Product\Attribute\AttributeController;
use App\Http\Controllers\Admin\BlogSystem\Category\BlogCategoryController;
use App\Http\Controllers\Admin\BlogSystem\Blog\BlogController;
use App\Http\Controllers\Admin\Product\Brand\BrandController;
use App\Http\Controllers\Admin\BusinessSettings\BusinessSettingsController;
use App\Http\Controllers\Admin\Category\CategoryController;
use App\Http\Controllers\Admin\SetupConfiguartions\CityController;
use App\Http\Controllers\Admin\Seller\Payment\CommissionController;
use App\Http\Controllers\Admin\Support\Conversations\ConversationController;
use App\Http\Controllers\Admin\SetupConfiguartions\CountryController;
use App\Http\Controllers\Admin\Marketing\Coupon\CouponController;
use App\Http\Controllers\Admin\Currency\CurrencyController;
use App\Http\Controllers\Admin\Customer\CustomerController;
use App\Http\Controllers\Admin\Customer\CustomerPackageController;
use App\Http\Controllers\Admin\Product\DigitalProductController;
use App\Http\Controllers\Admin\Marketing\FlashDeals\FlashDealController;
...
use App\Http\Controllers\Admin\Seller\Payment\PaymentController;
use App\Http\Controllers\Admin\SetupConfiguartions\PickupPointController;
use App\Http\Controllers\Admin\Product\ProductBulkUploadController;
use App\Http\Controllers\Admin\Product\ProductController;
use App\Http\Controllers\Admin\Profile\ProfileController;
use App\Http\Controllers\Admin\Reports\ReportController;
use App\Http\Controllers\Admin\Staff\StaffRole\RoleController;
use App\Http\Controllers\Admin\Product\Reviews\ReviewContReviewControllerroller;
use App\Http\Controllers\Admin\Seller\SellerController;
use App\Http\Controllers\Admin\Seller\SellerWithdrawRequestController;
use App\Http\Controllers\Admin\Staff\Staffs\StaffController;
use App\Http\Controllers\Admin\SetupConfiguartions\StateController;
use App\Http\Controllers\Admin\Marketing\Subscribers\SubscriberController;
use App\Http\Controllers\Admin\Support\Ticket\SupportTicketController;
...
use App\Http\Controllers\Api\V2\HyperPayUtility\HyperPayController;
...
Route::group(['prefix' => 'admin', 'middleware' => ['auth', 'admin']], function() {
    ...
    Route::controller(ProductController::class)->group(function () {
        ...
        Route::post('/products/new', 'updateNew')->name('products.new');
        Route::post('/products/soon', 'updateSoon')->name('products.soon');
        ...
        Route::post('/products/best-selling', 'updateBestSelling')->name('products.best-selling');
    ...
    Route::resource('/withdrawAdmin\Seller\_requests', SellerWithdrawRequestController::class);
    ...
    Route::controller(BusinessSettingsController::class)->group(function () {
        ...
        //Hyper Pay configuration
        Route::get('/payment-configuration', 'payment_configuration')->name('payment_configuration.index');
        Route::post('/payment-configuration-update', 'payment_configuration_update')->name('payment_configuration.update');
        Route::get('/payment-activation', 'payment_activation')->name('payment_activation.index');
    });
    ...
    Route::get('all-orders-export' , [ProductController::class , 'exportAllORders'])->name('orders.export');
    Route::get('all-orders-import-template' , [ProductController::class , 'importIndex'])->name('orders.import.index');
    Route::post('/bulk-orders-upload', [ProductController::class ,  'bulkOrderUpload'])->name('bulk_orders_upload');
    ...
    Route::controller(OrderController::class)->group(function () {
        ...
        Route::get('/all_today_orders', 'all_today_orders')->name('all_today_orders');
        ...
        Route::post('/bulk-order-export', 'bulk_order_export')->name('bulk-order-export');
    ...
    Route::post('/order-stauts-change' , [OrderStatusController::class  , function(){dd('aaa');}])->name('order.status.change');
