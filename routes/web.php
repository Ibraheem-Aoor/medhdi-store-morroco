...
use App\Http\Controllers\Auth\LoginController;
    ...
    use App\Http\Controllers\Customer\CurrencyController;
    ...
    use App\Http\Controllers\Customer\SubscriberController;
...
use App\Http\Controllers\Lnading\LandingPageController;
    ...
    */
    ...
    Route::controller(HomeController::class)->group(function () {
        ...
        Route::post('/home/section/random_products', 'load_random_products_section')->name('home.section.random_products');
        Route::post('/home/section/load_random_products', 'load_more_random_products_section')->name('home.section.load_random_products');
    ...
    Route::controller(CustomerProductController::class)->group(function () {
        ...
        Route::post('/product-updateqty', 'updateQty')->name('product.updateQuantity');
        Route::post('/product-updateqty-2', 'updateQty_2')->name('product.updateQuantity_2');
    });
    ...
    // Route::group(['middleware' => ['customer', 'unbanned']], function() {
        ...
        Route::group(['prefix' => 'checkout'], function() {
            Route::controller(CheckoutController::class)->group(function () {
                ...
                Route::get('/order-confirmed/{id}', 'getOrderConfirmedPage')->name('order_confirmed');
    ...
    // Route::group(['middleware' => ['auth']], function() {
        ...
        Route::controller(AddressController::class)->group(function () {
            ...
            Route::get('/addresses', 'all_address')->name('shipping_addresses');
        });
    ...
    Route::controller(PageController::class)->group(function () {
      ...
      Route::prefix('/payment')->group(function () {
        Route::get('/checkout' ,[ HyperPayController::class , 'first_step'])->name('hyperPay.first_step');
        Route::get('/proccess' , [HyperPayController::class , 'second_step'])->name('hyperPay.second_step');
    });


    //landing page demo booking
    Route::post('/test-landing' , [LandingPageController::class , 'submitForm'])->name('landing.submit');
