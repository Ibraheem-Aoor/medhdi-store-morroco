    ...
    <div class="aiz-sidebar left c-scrollbar">
                ...
                @else
                    ...
                    @if ($header_logo != null)
                        <img src="{{ uploaded_asset(get_setting('system_logo_black')) }}" alt="{{ env('APP_NAME') }}"
                            class="mw-100"  style="width:70%;">
                    @endif
                @endif
                <h3 class="fs-16 mt-2  m-0 text-white">{{ Auth::user()->shop->name }}</h3>
                <h1 class="fs-12 mt-2  m-0 text-white">
                    <a href="{{ route('shop.visit', Auth::user()->shop->slug) }}"
                        class="btn btn-link btn-sm text-white store-name" target="_blank">{{ translate('Visit My Shop') }}</a>
                </h1>
        ...
        <div class="aiz-side-nav-wrap">
            ...
            <ul class="aiz-side-nav-list" id="main-menu" data-toggle="aiz-side-menu">
                ...
                <li class="aiz-side-nav-item">
                    <a href="{{ route('seller.customers') }}" class="aiz-side-nav-link">
