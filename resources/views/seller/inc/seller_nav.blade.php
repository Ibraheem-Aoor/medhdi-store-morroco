        ...
        <div class="aiz-topbar-nav-toggler d-flex align-items-center justify-content-start mr-2 mr-md-3 ml-0" data-toggle="aiz-mobile-nav">
            <button class="btn p-2 bg-transparent">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" width="21" height="21">
                    <g data-name="Burger Menu"><rect width="32" height="32" fill="#fff" opacity="0"/><line x1="3" x2="29" y1="8" y2="8" fill="none" stroke="#231f20" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"/><line x1="7" x2="25" y1="16" y2="16" fill="none" stroke="#231f20" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"/><line x1="3" x2="29" y1="24" y2="24" fill="none" stroke="#231f20" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"/></g></svg>
            </button>
        </div>
    </div>
                ...
                <div class="align-items-stretch d-flex dropdown " id="lang-change">
                    <a class="dropdown-toggle no-arrow" data-toggle="dropdown" href="javascript:void(0);" role="button" aria-haspopup="false" aria-expanded="false">
                        <span class="btn btn-icon" style="display: flex;align-items: center;">
                            <img src="{{ asset('assets/img/flags/'.$locale.'.png') }}" width="22" height="auto">
                        </span>
                    </a>
                        ...
                        @foreach (\App\Models\Language::all() as $key => $language)
                            <li>
                                <a href="javascript:void(0)" data-flag="{{ $language->code }}" class="dropdown-item @if($locale == $language->code) active @endif">
                                    <img src="{{ asset('assets/img/flags/'.$language->code.'.png') }}" class="mr-2"  width="22" height="auto">
            ...
            <div class="aiz-topbar-item ml-2">
                <div class="align-items-stretch d-flex dropdown" id="user-menu">
                    ...
                    <div class="dropdown-menu dropdown-menu-right dropdown-menu-animated dropdown-menu-sm">
                        <a href="{{ route('seller.profile.index') }}" class="dropdown-item fs-14">
                            <i class="las la-user-circle la-lg"></i>
                            <span>{{translate('Profile')}}</span>
                        </a>

                        <a href="{{ route('logout')}}" class="dropdown-item fs-14">
