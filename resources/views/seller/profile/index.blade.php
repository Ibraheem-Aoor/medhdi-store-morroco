        ...
        <div class="card-header">
            ...
            <div class="col-md-3">
                <div class="d-flex justify-content-end">
                    <a href="javascript:;" class="btn btn-primary text-white py-2" onclick="add_new_address()">
                        <div class="fs-14">{{ translate('Add New Address') }}</div>
                    </a>
                </div>
            </div>
                                ...
                                <div class="col-md-10">
                                    <div class="mb-3">
                                        <select class="form-control aiz-selectpicker" data-live-search="true" data-placeholder="{{ translate('Select your country') }}" name="country_id" required>
                                            ...
                                            @foreach (\App\Models\Country::where('is_active', 1)->get() as $key => $country)
