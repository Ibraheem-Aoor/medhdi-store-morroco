    ...
    <div class="row">
                                ...
                                <select class="form-control aiz-selectpicker" name="DEFAULT_LANGUAGE"
                                    ...
                                    @foreach (\App\Models\Language::where('status', 1)->get() as $key => $language)
                                        ...
                                        <option value="{{ $language->code }}"
                                            @if (env('DEFAULT_LANGUAGE') == $language->code) selected @endif>
                                            {{ $language->name }}
                                        </option>
                                    @endforeach
                                </select>
        ...
        <div class="col-lg-6">
            ...
            {{-- <div class="card">
                ...
                <div class="card-body">
                    <form class="form-horizontal" action="{{ route('app-translations.import') }}" method="POST"
                            ...
                            <div class="col-lg-6">
                                <div class="custom-file">
                                    <label class="custom-file-label">
                                        <input type="file" id="lang_file" name="lang_file" class="custom-file-input"
                                            required>
                        ...
                        <tr>
                            ...
                            <td class="text-right">
                                ...
                                <a class="btn btn-soft-warning btn-icon btn-circle btn-sm"
                                    href="{{ route('app-translations.show', $language->id) }}"
                                    title="{{ translate('App Translation') }}">
                                    <i class="las la-language"></i>
                                </a>
                                <a class="btn btn-soft-success btn-icon btn-circle btn-sm"
                                    href="{{ route('app-translations.export', $language->id) }}"
                                    title="{{ translate('arb File Export') }}" download>
