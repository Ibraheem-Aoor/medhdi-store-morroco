                    ...
                    <tbody>
                        @foreach ($products as $key => $product)
                            <tr>
                                ...
                                <td>
                                    <label class="aiz-switch aiz-switch-success mb-0">
                                        <input onchange="update_new(this)" value="{{ $product->id }}" type="checkbox"
                                ...
                                <td>
                                    <label class="aiz-switch aiz-switch-success mb-0">
                                        <input onchange="update_soon(this)" value="{{ $product->id }}" type="checkbox"
                                            <?php if ($product->soon == 1) {
                                                echo 'checked';
                                            } ?>>
                                        <span class="slider round"></span>
                                    </label>
    ...
    <script type="text/javascript">
            ...
            $.post('{{ route('products.new') }}', {
                ...
                if (data == 1) {
                    AIZ.plugins.notify('success',
                        '{{ translate('New') . ' ' . translate('Label updated successfully') }}');
                } else {
                    AIZ.plugins.notify('danger', '{{ translate('Something went wrong') }}');
                }
            });
            ...
            $.post('{{ route('products.soon') }}', {
                ...
                if (data == 1) {
                    ...
                    AIZ.plugins.notify('danger',
                        '{{ translate('Soon') . ' ' . translate('Label updated successfully') }}');
                }
            });
        }
        ...
        function update_best_selling(el) {
            ...
            $.post('{{ route('products.best-selling') }}', {
                ...
                if (data == 1) {
                    AIZ.plugins.notify('success',
                        '{{ translate('best_selling') . ' ' . translate('Label updated successfully') }}');
                } else {
                    AIZ.plugins.notify('danger', '{{ translate('Something went wrong') }}');
                }
            });
