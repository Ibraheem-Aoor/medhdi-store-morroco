                ...
                <div class="col-lg-8">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            {{-- <div class="col-md-8"> --}}
                            <input type="text" class="form-control" name="unit" value="PC" hidden
                    ...
                    <div class="btn-toolbar float-right mb-3" role="toolbar" aria-label="Toolbar with button groups">
                        <div class="btn-group mr-2" role="group" aria-label="First group">
                            <button type="submit" name="button" value="draft"
                                class="btn btn-secondary action-btn">{{ translate('Save As Draft') }}</button>
                        </div>
    ...
    <script type="text/javascript">
        ...
        $('input[name="colors_active"]').on('change', function() {
            if (!$('input[name="colors_active"]').is(':checked')) {
                ...
                $('#colors').removeAttribute('required');
                AIZ.plugins.bootstrapSelect('refresh');
            } else {
                $('#colors').prop('enabled', false);
                $('#colors').setAttribute('required', 'required');
                AIZ.plugins.bootstrapSelect('refresh');
            }
            update_sku();
        });
