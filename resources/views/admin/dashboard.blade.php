...
@section('content')
    ...
    @if (Auth::user()->user_type == 'admin' || in_array('1', json_decode(Auth::user()->staff->role->permissions)))
        <div class="row gutters-10">
                ...
                <div class="row gutters-10">
                        ...
                        <div class="bg-grad-2 text-white rounded-lg mb-4 overflow-hidden">
                            <div class="px-3 pt-3">
                                <div class="opacity-100">
                                    ...
                                    <span class="fs-18 d-block">{{ translate('Today\'s Orders') }}</span>
                                </div>
                                <div class="h3 fw-700 mb-3">
                                    {{ \App\Models\Order::where('created_at', 'like' , '%'.\Carbon\Carbon::today()->toDateString()."%")->count() }}
                                </div>
                            </div>
                    ...
                    <div class="col-lg-3 col-md-6 col-12">
                        <div class="bg-grad-3 text-white rounded-lg mb-4 overflow-hidden">
                            <div class="px-3 pt-3">
                                <div class="opacity-100">
                                    <span class="fs-13 d-block">{{ translate('Total') }}</span>
                                    <span class="fs-18 d-block"> {{ translate('Order') }} </span>
                                </div>
                    ...
                    <div class="col-lg-3 col-md-6 col-12">
                        <div class="bg-grad-1 text-white rounded-lg mb-4 overflow-hidden">
                            <div class="px-3 pt-3">
                                <div class="opacity-100">
                                    <span class="fs-18 d-block">{{ translate('Today Income') }}</span>
                                </div>
                                <div class="h3 fw-700 mb-3">{{ \App\Models\Currency::findOrFail(get_setting('system_default_currency'))->code }} {{ \App\Models\Order::where('created_at', 'like' , '%'.today()->toDateString().'%')->sum('grand_total') }} </div>
                            </div>
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">
                                <path fill="rgba(255,255,255,0.3)" fill-opacity="1"
                                    d="M0,128L34.3,112C68.6,96,137,64,206,96C274.3,128,343,224,411,250.7C480,277,549,235,617,213.3C685.7,192,754,192,823,181.3C891.4,171,960,149,1029,117.3C1097.1,85,1166,43,1234,58.7C1302.9,75,1371,149,1406,186.7L1440,224L1440,320L1405.7,320C1371.4,320,1303,320,1234,320C1165.7,320,1097,320,1029,320C960,320,891,320,823,320C754.3,320,686,320,617,320C548.6,320,480,320,411,320C342.9,320,274,320,206,320C137.1,320,69,320,34,320L0,320Z">
                    ...
                    <div class="col-lg-3 col-md-6 col-12">
                        <div class="bg-grad-4 text-white rounded-lg mb-4 overflow-hidden">
                            <div class="px-3 pt-3">
                                <div class="opacity-100">
                                    <span class="fs-18 d-block">{{ translate('Total Income') }}</span>
                                </div>
                                <div class="h3 fw-700 mb-3">{{ \App\Models\Currency::findOrFail(get_setting('system_default_currency'))->code }} {{ \App\Models\Order::sum('grand_total') }}</div>
                            </div>
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">
                                <path fill="rgba(255,255,255,0.3)" fill-opacity="1"
                                    d="M0,128L34.3,112C68.6,96,137,64,206,96C274.3,128,343,224,411,250.7C480,277,549,235,617,213.3C685.7,192,754,192,823,181.3C891.4,171,960,149,1029,117.3C1097.1,85,1166,43,1234,58.7C1302.9,75,1371,149,1406,186.7L1440,224L1440,320L1405.7,320C1371.4,320,1303,320,1234,320C1165.7,320,1097,320,1029,320C960,320,891,320,823,320C754.3,320,686,320,617,320C548.6,320,480,320,411,320C342.9,320,274,320,206,320C137.1,320,69,320,34,320L0,320Z">
            ...
            <div class="col-lg-12">
                <div class="row gutters-10">
                    <div class="col-{{$ordersCount > 0 ? 6 : 12}}">
                        <div class="card">
                            <div class="card-header">
                                <h6 class="mb-0 fs-14">{{ translate('Products') }}</h6>
                            </div>
                            <div class="card-body">
                                <canvas id="pie-1" class="w-100" height="220"></canvas>
                            </div>
                        </div>
                    </div>
                    @if ( $ordersCount > 0)
                        <div class="col-6">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <canvas id="pie-2" class="w-100" height="220"></canvas>
                                </div>
                            </div>
                        </div>
                    @endif
    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="aiz-carousel gutters-10 half-outside-arrow" data-items="6" data-xl-items="5" data-lg-items="4"
                ...
                @foreach (filter_products(\App\Models\Product::where('published', 1)->orderBy('num_of_sale', 'desc'))->limit(12)->get()
        as $key => $product)
                ...
                datasets: [{
                    data: [
                        ...
                        @php
                            ...
                            $inHouseOrdersCount = \App\Models\Order::where('seller_id', $admin_user_id)->count();
                        @endphp
                        {{ $inHouseOrdersCount }},
                    ],
                    backgroundColor: [
