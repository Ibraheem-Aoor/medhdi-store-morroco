        ...
        <div style="background: #eceff4;padding: 1rem;">
            <table>
                <tr>
                    <td>
                        @if ($logo != null)
                            <img src="{{ uploaded_asset(get_setting('system_logo_black')) }}" height="30"
            ...
            <table>
                ...
                <tr>
                    @if (get_setting('contact_email') != null)
                        <td class="gry-color small">{{ translate('Email') }}: {{ get_setting('contact_email') }}
                        </td>
                    @endif
                ...
                <tr>
                    @if (get_setting('contact_phone') != null)
                        <td class="gry-color small">{{ translate('Phone') }}: {{ get_setting('contact_phone') }}
                        </td>
                    @endif
