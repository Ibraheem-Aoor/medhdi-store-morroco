                    ...
                    <form action="{{ route('business_settings.update') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="home-slider-target">
                                <input type="hidden" name="appLang" value="{{ app()->getLocale() }}">
                                ...
                                @if (get_setting('home_slider_images', null, app()->getLocale()) != null)
                                    @foreach (json_decode(get_setting('home_slider_images', null, app()->getLocale()), true) as $key => $value)
                                                ...
                                                <div class="form-group">
                                                    <div class="input-group" data-toggle="aizuploader" data-type="image">
                                                        ...
                                                        <input type="hidden" name="home_slider_images[]"
                                                            ...
                                                            value="{{ json_decode(get_setting('home_slider_images', null, app()->getLocale()), true)[$key] }}">
                                                    </div>
                    ...
                    <form action="{{ route('business_settings.update') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="home-banner1-target">
                                ...
                                @if (get_setting('home_banner1_images', null, app()->getLocale()) != null)
                                    @foreach (json_decode(get_setting('home_banner1_images', null, app()->getLocale()), true) as $key => $value)
                                        <div class="row gutters-5">
                                            <div class="col-md-5">
                                                <div class="form-group">
                                                    <div class="input-group" data-toggle="aizuploader" data-type="image">
                                                        ...
                                                        <input type="hidden" name="home_banner1_images[]"
                                                            class="selected-files"
                                                            value="{{ json_decode(get_setting('home_banner1_images', null, app()->getLocale()), true)[$key] ?? '#' }}">
                                                    </div>
                                                    <div class="file-preview box sm">
                                                    </div>
                                                </div>
                    ...
                    <form action="{{ route('business_settings.update') }}" method="POST"
                        ...
                        <div class="form-group">
                            ...
                            <div class="home-banner2-target">
                                ...
                                @if (get_setting('home_banner2_images', null, app()->getLocale()) != null)
                                    @foreach (json_decode(get_setting('home_banner2_images', null, app()->getLocale()), true) as $key => $value)
                                        <div class="row gutters-5">
                                            <div class="col-md-5">
                                                <div class="form-group">
                                                    <div class="input-group" data-toggle="aizuploader" data-type="image">
                                                        ...
                                                        <input type="hidden" name="home_banner2_images[]"
                                                            class="selected-files"
                                                            value="{{ json_decode(get_setting('home_banner2_images', null, app()->getLocale()), true)[$key] }}">
                                                    </div>
                                                    <div class="file-preview box sm">
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col">
                                                <div class="form-group">
                                                    <select class="form-control aiz-selectpicker" name="home_categories[]"
                                                        ...
                                                        required>
                                                        @foreach (\App\Models\Category::where('parent_id', 0)->with('childrenCategories')->get()
        as $category)
                    ...
                    <form action="{{ route('business_settings.update') }}" method="POST"
                        ...
                        <div class="form-group">
                            ...
                            <div class="home-banner3-target">
                                ...
                                @if (get_setting('home_banner3_images' , null , app()->getLocale()) != null)
                                    @foreach (json_decode(get_setting('home_banner3_images' , null , app()->getLocale()), true) as $key => $value)
                                        <div class="row gutters-5">
                                            <div class="col-md-5">
                                                <div class="form-group">
                                                    <div class="input-group" data-toggle="aizuploader" data-type="image">
                                                        ...
                                                        <input type="hidden" name="home_banner3_images[]"
                                                            class="selected-files"
                                                            value="{{ json_decode(get_setting('home_banner3_images' , null ,app()->getLocale()), true)[$key] }}">
                                                    </div>
                                                    <div class="file-preview box sm">
                                                    </div>
                                                </div>
