                    ...
                    <form action="{{ route('business_settings.update') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="col-md-8">
                                    <div class=" input-group " data-toggle="aizuploader" data-type="image">
                                        ...
                                        <input type="hidden" name="topbar_banner" class="selected-files"
                                            value="{{ get_setting('topbar_banner') }}">
                                    </div>
                                    <div class="file-preview"></div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-8">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control"
                                            ...
                                            name="topbar_banner_link" value="{{ get_setting('topbar_banner_link') }}">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="border-top pt-3">
                            ...
                            <div class="header-nav-menu">
                                ...
                                @if (get_setting('header_menu_labels', null ,$lang) != Null)
                                    @foreach (json_decode(get_setting('header_menu_labels', null, $lang), true) as $key => $value)
