        ...
        <div class="aiz-side-nav-logo-wrap">
            <a href="{{ route('admin.dashboard') }}" class="d-block text-left">
                @if (get_setting('system_logo_white') != null)
                    <img class="mw-100" height="80px" src="{{ uploaded_asset(get_setting('system_logo_white')) }}"
                        alt="{{ get_setting('site_name') }}" style="width:70%;">
                    {{-- @else
                    <img class="mw-100" height="80px" src="{{ asset('assets/img/logo.png') }}"
            ...
            <ul class="aiz-side-nav-list" id="main-menu" data-toggle="aiz-side-menu">
                ...
                <li class="aiz-side-nav-item">
                    ...
                    <ul class="aiz-side-nav-list level-2">
                        @if (Auth::user()->user_type == 'admin' || in_array('3', json_decode(Auth::user()->staff->role->permissions)))
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('all_today_orders') }}"
                                    class="aiz-side-nav-link {{ areActiveRoutes(['all_today_orders']) }}">
                                    <span class="aiz-side-nav-text">{{ translate('All Today Orders') }}</span>
                                </a>
                            </li>
                            <li class="aiz-side-nav-item">
                            ...
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('order-status.index') }}"
                                    class="aiz-side-nav-link {{ areActiveRoutes(['order-status.index']) }}">
                                    <span class="aiz-side-nav-text">{{ translate('Order Status') }}</span>
                                </a>
                            </li>
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('orders.import.index') }}"
                                    class="aiz-side-nav-link {{ areActiveRoutes(['orders.import']) }}">
                                    <span class="aiz-side-nav-text">{{ translate('Bulk Import') }}</span>
                                </a>
                            </li>
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('orders.export') }}"
                                    class="aiz-side-nav-link {{ areActiveRoutes(['orders.export']) }}">
                                    <span class="aiz-side-nav-text">{{ translate('Bulk Export') }}</span>
                                </a>
                            </li>
                        @endif
                            ...
                            <ul class="aiz-side-nav-list level-2">
                                ...
                                <li class="aiz-side-nav-item">
                                    <a href="{{ route('delivery-boys-collection-histories') }}"
                                        class="aiz-side-nav-link">
                                        <span
                                            class="aiz-side-nav-text">{{ translate('Collected Histories') }}</span>
                                    </a>
                                </li>
                                <li class="aiz-side-nav-item">
                            ...
                            <ul class="aiz-side-nav-list level-2">
                                ...
                                <li class="aiz-side-nav-item">
                                    <a href="{{ route('refund_time_config') }}" class="aiz-side-nav-link">
                                        <span
                                            class="aiz-side-nav-text">{{ translate('Refund Configuration') }}</span>
                                    </a>
                                </li>
                            </ul>
                        </li>
                            ...
                            <ul class="aiz-side-nav-list level-2">
                                <li class="aiz-side-nav-item">
                                    <a href="{{ route('otp.configconfiguration') }}" class="aiz-side-nav-link">
                                        <span
                                            class="aiz-side-nav-text">{{ translate('OTP Configurations') }}</span>
                                    </a>
                                </li>
                                <li class="aiz-side-nav-item">
                                ...
                                <li class="aiz-side-nav-item">
                                    <a href="{{ route('otp_credentials.index') }}" class="aiz-side-nav-link">
                                        <span
                                            class="aiz-side-nav-text">{{ translate('Set OTP Credentials') }}</span>
                                    </a>
                                </li>
                            </ul>
                        </li>
                ...
                @if (Auth::user()->user_type == 'admin' || in_array('13', json_decode(Auth::user()->staff->role->permissions)))
                    <li class="aiz-side-nav-item">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('website.header', ['lang' => App::getLocale()]) }}"
                                    class="aiz-side-nav-link">
                ...
                @if (Auth::user()->user_type == 'admin' || in_array('14', json_decode(Auth::user()->staff->role->permissions)))
                    <li class="aiz-side-nav-item">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            ...
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('payment_activation.index') }}" class="aiz-side-nav-link">
                                    <span class="aiz-side-nav-text">{{ translate('Payment Activation') }}</span>
                                </a>
                            </li>  --}}
                            {{-- <li class="aiz-side-nav-item">
                                <a href="{{ route('payment_configuration.index') }}" class="aiz-side-nav-link">
                                    <span class="aiz-side-nav-text">{{ translate('Payment Configuration') }}</span>
                                </a>
                            </li> --}}
                            {{-- <li class="aiz-side-nav-item">
