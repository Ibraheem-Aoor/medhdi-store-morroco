...
@section('title', translate('Bulk Import'))
@section('content')

    <div class="card">
        <div class="card-header">
            <h5 class="mb-0 h6">{{ translate('Orders Bulk Upload') }}</h5>
        </div>
        <div class="card-body">
            <div class="alert"
            ...
            <br>
            <div class="">
                <a href="{{ asset('download/orders_bulk_demo.xlsx') }}" download><button
    ...
    <div class="card">
        <div class="card-header">
            <h5 class="mb-0 h6"><strong>{{ translate('Upload Order File') }}</strong></h5>
        </div>
        <div class="card-body">
            <form class="form-horizontal" action="{{ route('bulk_orders_upload') }}" method="POST"
...
@section('script')
    <script>
        @if (Session::has('error'))
            AIZ.plugins.notify('error', "{{ Session::get('error') }}");
