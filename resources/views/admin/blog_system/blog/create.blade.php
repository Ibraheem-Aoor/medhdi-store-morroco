        ...
        @foreach (\App\Models\Language::all() as $key => $language)
            <li class="nav-item">
                <a class="nav-link text-reset @if ($language->code == $lang) active @else bg-soft-dark border-light border-left-0 @endif py-3"
                    href="{{ route('blog.create', ['lang' => $language->code]) }}">
    ...
    <div class="row">
        <div class="col-lg-12 mx-auto">
            <div class="card">
                ...
                <div class="card-body">
                    <form id="add_form" class="form-horizontal" action="{{ route('blog.store', ['lang' => $lang]) }}"
                        method="POST">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input type="text" placeholder="{{ app()->getLocale() == 'en' ? 'Author' : 'الكاتب' }}" name="author"
