...
@section('title', translate('All Posts'))
@section('content')
...
<div class="aiz-titlebar text-left mt-2 mb-3">
    <div class="row align-items-center">
        ...
        <div class="col text-right">
            <a href="{{ route('blog.create' , ['lang' => $lang]) }}" class="btn btn-circle btn-info">
                    ...
                    <tr>
                        ...
                        <td>
                            @if($blog->category != null)
                                {{ $blog->category->getTranslation('category_name' , App()->getLocale()) }}
                            @else
                                --
                            @endif
                        </td>
                        ...
                        <td class="text-right">
                            <a class="btn btn-soft-primary btn-icon btn-circle btn-sm" href="{{ route('blog.edit',['lang' => $lang  , $blog->id])}}" title="{{ translate('Edit') }}">
                                <i class="las la-pen"></i>
                            </a>

                            <a href="#" class="btn btn-soft-danger btn-icon btn-circle btn-sm confirm-delete" data-href="{{route('blog.destroy', ['lang' => $lang ,  $blog->id])}}" title="{{ translate('Delete') }}">
