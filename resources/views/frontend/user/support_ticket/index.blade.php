...
@section('panel_content')
    ...
    {{-- <div class="row">
        <div class="col-md-12 mx-auto mb-3" >
            <div class="p-4 rounded mb-3 c-pointer text-center bg-white shadow-sm" data-toggle="modal" data-target="#ticket_modal">
                <span class="size-50px rounded-circle mx-auto bg-secondary d-flex align-items-center justify-content-center mb-3">
                    <i class="las la-plus la-2x text-white"></i>
                </span>
    ...
    <div class="card">
        <div class="card-header">
            ...
            <button class="btn btn-sm btn-outline-primary" data-toggle="modal" data-target="#ticket_modal">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body px-3 pt-3">
                    <form class="" action="{{ route('support_ticket.store') }}" method="post"
                        enctype="multipart/form-data" id="ticketSubmitform">
                        @csrf
                        <div class="row">
                            <div class="col-md-2">
