                    ...
                    <table class="table table-borderless">
                        ...
                        <tr>
                            ...
                            <td>{{ json_decode($order->shipping_address)->address }},
                                {{ json_decode($order->shipping_address)->city }}</td>
                        </tr>
                    </table>
                </div>
                <div class="col-lg-6">
                    <table class="table table-borderless">
                        ...
                        <tr>
                            ...
                            {{-- </td> --}}
                            <td>
                                {{ single_price($order->combined_order->grand_total) }}
                            </td>
                        </tr>
                        <tr>
                    ...
                    <table class="table table-borderless table-responsive">
                        <thead>
                            <tr>
                                ...
                                @endif
                                <th class="text-right">{{ translate('Review') }}</th>
                            </tr>
                        </thead>
                        <tbody>
                    ...
                    <table class="table table-borderless">
                        <tbody>
                            ...
                            <tr>
                                ...
                                @php
                                    $grandTotalWithTax = $order->combined_order->grand_total;
                                    $grandTotalWithoutTax = 0;
                                    $taxInPercent = 0;
                                    $result = 0;
                                    if (get_setting('general_tax_type') == 'percent') {
                                        $taxInPercent = get_setting('tax_value') / 100;
                                        $grandTotalWithoutTax = $grandTotalWithTax - $grandTotalWithTax * $taxInPercent;
                                        $result = $grandTotalWithoutTax * $taxInPercent;
                                    } else {
                                        $result = get_setting('tax_value');
                                    }
                                @endphp
                                <td class="text-right">
                                    <span class="text-italic">{{ single_price($result) }}</span>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td class="text-right">
                                    <strong><span>{{ single_price($order->combined_order->grand_total) }}</span></strong>
                                </td>
                            </tr>
                        </tbody>
                    </table>
