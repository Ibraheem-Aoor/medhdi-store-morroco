    ...
    <section class="mb-4">
        <div class="container">
            <div class="px-2 py-4 px-md-4 py-md-3 bg-white shadow-sm rounded">
                ...
                <div class="aiz-carousel gutters-10 half-outside-arrow" data-items="3" data-lg-items="3"  data-md-items="2" data-sm-items="2" data-xs-items="1" data-rows="1">
                                    ...
                                    <div class="col-4">
                                        <a href="{{ route('shop.visit', $seller->slug) }}" class="d-block p-3">
                                            <img
                                                ...
                                                alt="{{ $seller->name }}"
                                                class="img-fluid lazyload" style=" height: 165px; object-fit: cover;"
                                            >
                                        </a>
                                    </div>
