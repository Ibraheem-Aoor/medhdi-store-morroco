            ...
            <div class="col-xxl-8 col-xl-10 mx-auto">
                <div class="shadow-sm bg-white p-3 p-lg-4 rounded text-center">
                                ...
                                <li class="list-group-item px-0">
                                    <div class="row gutters-5">
                                        ...
                                        <div class="col-lg-1 col-6 order-5 order-lg-0 text-center">
                                            <a href="javascript:void(0)" onclick="removeFromCartView(event, {{ $cartItem['id'] }} , this)" class="btn btn-icon btn-sm btn-soft-primary btn-circle">
                    ...
                    <div class="px-3 py-2 mb-4 border-top d-flex justify-content-between">
                        ...
                        <span class="fw-600 fs-17" id="total_span">{{ single_price($total) }}</span>
                    </div>
