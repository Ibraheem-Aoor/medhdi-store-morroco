<div class="modal-body p-4 added-to-cart">
    <div class="text-center text-success mb-4 add-to-cart-alert">
    ...
    <div class="bg-white rounded shadow-sm">
        ...
        <div class="p-3">
            <div class="aiz-carousel gutters-5 half-outside-arrow" data-items="4" data-xl-items="4" data-lg-items="4"
                data-md-items="4" data-sm-items="4" data-xs-items="4" data-arrows='true' data-infinite='true'>
                @foreach (filter_products(\App\Models\Product::where('category_id', $product->category_id)->where('id', '!=', $product->id))->limit(4)->get()
    as $key => $related_product)
                    <div class="carousel-box">
                        <div class="aiz-card-box border border-light rounded hov-shadow-md my-2 has-transition">
                            <div class="">
                                <a href="{{ route('product', $related_product->slug) }}" class="d-block">
                                    <img class="img-fit lazyload mx-auto h-140px h-md-150px"
    ...
    <div class="text-center mt-3">
        <button class="btn buy-now-btn mb-3 mb-sm-0" data-dismiss="modal">{{ translate('Back to shopping') }}</button>
        <a href="{{ route('cart') }}"
            class="btn add-to-cart-btn mb-3 mb-sm-0">{{ translate('Proceed to Checkout') }}</a>
    </div>
</div>
