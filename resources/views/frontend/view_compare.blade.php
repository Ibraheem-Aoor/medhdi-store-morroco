                                    ...
                                    <tr>
                                        ...
                                        @foreach (Session::get('compare') as $key => $item)
                                            <td class="text-center py-4">
                                                <button type="button" class="btn add-to-cart-btn fw-600" onclick="showAddToCartModal({{ $item }})">
            ...
            @else
                <div class="text-center p-4">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="80" height="80">
                        <path d="M4 4H20V8H4z" opacity=".3" fill="#c7c7c7" />
                        <path d="M19,21H5c-1.1,0-2-0.9-2-2V5c0-1.1,0.9-2,2-2h14c1.1,0,2,0.9,2,2v14C21,20.1,20.1,21,19,21z M5,5v14h14V5H5z" fill="#c7c7c7" />
                        <path d="M4 7H20V9H4zM7 11H9V13H7zM11 11H17V13H11zM7 15H9V17H7zM11 15H17V17H11z" fill="#c7c7c7" />
                    </svg>
