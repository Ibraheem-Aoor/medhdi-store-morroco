<div class="aiz-user-sidenav-wrap position-relative z-1 shadow-sm user-dashboard">
    <div class="aiz-user-sidenav rounded overflow-auto c-scrollbar-light pb-5 pb-xl-0">
        <div class="p-4 text-xl-center mb-4 border-bottom bg-primary text-white position-relative user-aside-head">
        ...
        <div class="sidemnenu mb-3">
            <ul class="aiz-side-nav-list px-2" data-toggle="aiz-side-menu">
                ...
                <li class="aiz-side-nav-item">
                    <a href="{{ route('shipping_addresses') }}"
                        class="aiz-side-nav-link {{ areActiveRoutes(['shipping_addresses']) }}">
                        <i class="las la-user aiz-side-nav-icon"></i>
                        <span class="aiz-side-nav-text">{{ translate('Shipping Addresses') }}</span>
                    </a>
                </li>
