            ...
            @if ($carts && count($carts) > 0)
                <div class="row">
                    <div class="col-xxl-8 col-xl-10 mx-auto">
                        <div class="shadow-sm bg-white p-3 p-lg-4 rounded text-center">
                            <div class="mb-4">
                                <div class="row gutters-5 d-none d-lg-flex border-bottom mb-3 pb-3">
                                    <div class="col-lg-5 fw-600  ">{{ translate('Product') }}</div>
                                    <div class="col-lg col-4 fw-600  ">{{ translate('Price') }}</div>
                                    <div class="col-lg col-4 fw-600  ">{{ translate('Tax') }}</div>
                                    <div class="col-lg col-6 fw-600  ">{{ translate('Quantity') }}</div>
                                    <div class="col-lg col-4 fw-600  ">{{ translate('Total') }}</div>
                                    <div class="col-lg-1 col-6 fw-600"></div>
                                </div>
                                    ...
                                    @foreach ($carts as $key => $cartItem)
                                        ...
                                        <li class="list-group-item px-0">
                                            <div class="row gutters-5">
                                                    ...
                                                    @if ($cartItem['digital'] != 1 && $product->auction_product == 0)
                                                        <div
                                                            ...
                                                            <input type="number" name="quantity[{{ $cartItem['id'] }}]"
                                                                class="col border-0 flex-grow-1 fs-16 input-number text-center"
                                                ...
                                                <div class="col-lg-1 col-6 order-5 order-lg-0 text-center">
                                                    <a href="javascript:void(0)"
                                                        onclick="removeFromCartView(event, {{ $cartItem['id'] }} , this)"
                                                        class="btn btn-icon btn-sm btn-soft-primary btn-circle p-0">
                            ...
                            {{-- Coupon Code --}}
                            {{-- <div class="col-lg-4 mt-4 mt-lg-0 cart-summary-box ml-auto mr-0" id="cart_summary">
                                    @include('frontend.partials.coupon_cart_view')
                                </div> --}}
                            {{-- End Coupon Code --}}
                            ...
                            <div class="px-3 py-2 mb-4 border-top d-flex justify-content-between">
                                ...
                                id="total_span">{{ single_price($total - $carts->sum('discount')) }}</span>
                            </div>
                            <div class="row align-items-center">
                                <div class="col-md-6 text-md-left order-1 order-md-0">
                                ...
                                <div class="col-md-6 text-md-right">
                                    <button class="btn btn-primary fw-600 " id="buy_now_button" onclick="buyNow(true);">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    @if (get_setting('google_login') == 1 || get_setting('facebook_login') == 1 || get_setting('twitter_login') == 1)
                        ...
                        <ul class="list-inline social colored mb-3">
...
@section('script')
    <script>
        $(document).on('hidden.bs.modal' , '#new-address-modal' , function()
        {
    ...
    <script type="text/javascript">
        ...
        function removeFromCartView(e, key , src = null) {
            e.preventDefault();
        ...
        function showCheckoutModal() {
            location.href = "{{ route('checkout.shipping_info') }}";
        }
        ...
        var iti = intlTelInput(input, {
            ...
            onlyCountries: @php
                echo json_encode(
                    \App\Models\Country::where('is_active', 1)
                        ->pluck('code')
                        ->toArray(),
                );
            @endphp,
