            ...
            <div class="row cols-xs-space cols-sm-space cols-md-space">
                <div class="col-xxl-8 col-xl-10 mx-auto">
                    <form class="form-default" data-toggle="validator"
                        ...
                        @csrf
                        <div class="shadow-sm bg-white p-4 rounded mb-4 position-relative">
                            <div class="d-flex justify-content-end mb-3">
                                <a href="#" class="btn btn-outline-primary btn-sm" onclick="add_new_address()">
                                    {{ translate('Add New Address') }}
                                </a>
                            </div>
                            <div class="row gutters-5">
                                @if (Session::has('address') && ($address = Session::get('address')) != null)
                                    <div class="col-md-6 mb-3">
                                        <label class="aiz-megabox d-block bg-white mb-0">
                                            ...
                                            <span class="d-flex p-3 aiz-megabox-elem">
                                                ...
                                                <span class="flex-grow-1 pl-3 text-left address-list">
                                                    <div class="address-list-item">
                                                        <span class="opacity-60">{{ translate('Name') }}:</span>
                                                        <span
                                                            class="fw-600 ml-2">{{ $address->name}}</span>
                                                    </div>
                                                    <div class="address-list-item">
                                                        <span class="opacity-60">{{ translate('City') }}:</span>
                                                        <span
                                                            class="fw-600 ml-2">{{ optional($address->city)->getTranslation('name') }}</span>
                                                    </div>
                                                    <div class="address-list-item">
                                                    ...
                                                    <div class="address-list-item">
                                                        <span class="opacity-60">{{ translate('Phone') }}:
                                                        </span>
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-6 text-center text-md-right">
                                <button type="submit"
                                    class="btn btn-primary fw-600">{{ translate('Continue to Payment') }}</a>
                            </div>
                        </div>
                    </form>
                </div>
