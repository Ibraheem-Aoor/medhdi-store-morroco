                                    ...
                                    <form class="form-default" role="form" action="{{ route('login') }}" method="POST">
                                        ...
                                        @else
                                            <div class="form-group">
                                                <input type="text" class="form-control{{ $errors->has('phone') ? ' is-invalid' : '' }}" value="{{ old('phone') }}" placeholder="{{  translate('phone') }}" name="phone" id="phone" autocomplete="off">
                                                @if ($errors->has('phone'))
                                                    <span class="invalid-feedback" role="alert">
...
@section('script')
    <script type="text/javascript">
        ...
        var iti = intlTelInput(input, {
            ...
            onlyCountries: @php echo json_encode(\App\Models\Country::where('is_active', 1)->pluck('code')->toArray()) @endphp,
