...
<div class="h-100 bg-cover bg-center py-5 d-flex align-items-center dash-login-page" style="background-image: url({{ uploaded_asset(get_setting('admin_login_background')) }})">
    <div class="container">
        <div class="row">
                    ...
                    <div class="card-body">
                        <div class="mb-4 text-center">
                            @if(get_setting('system_logo_black') != null)
                                <img src="{{ uploaded_asset(get_setting('system_logo_black')) }}" class="mw-100 mb-2" height="45" width="263">
                            @else
                                <img src="{{ asset('assets/img/logo.png') }}" class="mw-100 mb-4" height="40">
                            @endif
                            <h1 class="h3 mb-0">{{ translate('Welcome to') }} {{ env('APP_NAME') }}</h1>
