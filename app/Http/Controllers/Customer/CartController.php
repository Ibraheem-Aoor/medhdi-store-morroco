...
class CartController extends Controller
{
    ...
    public function addToCart(Request $request)
    {
        ...
        if($product->auction_product == 0){
            return $this->addActionProductToCart($request , $product , $data , $carts , $str , $tax);
        }
        else{
    ...
    public function removeFromCart(Request $request)
    {
        ...
        $userCart = Cart::where('temp_user_id', $temp_user_id);
        $total = ($userCart->sum('price') + $userCart->sum('tax'))  * $userCart->sum('quantity');

        return array(
            'cart_count' => count($carts),
            // 'cart_view' => view('frontend.partials.cart_details', compact('carts'))->render(),
            'nav_cart_view' => view('frontend.partials.cart')->render(),
            'total' => $total - $userCart->sum('discount'),
        );
    }
    ...
    public function addActionProductToCart($request , $product , $data , $carts , $str , $tax)
    {
