...
class HomeController extends Controller
{
    ...
    public function index()
    {
        ...
        /*
        Cache::rememberForever('featured_categories', function () {
            return Category::where('featured', 1)->get();
        });
        */

        $todays_deal_products = filter_products(Product::where('published', 1)->where('todays_deal', '1'))->orderByDesc('created_at')->get() ?? [];
        /*
        $todays_deal_products = Cache::rememberForever('todays_deal_products', function () {
        });
        */
        $newest_products =  filter_products(Product::latest())->limit(12)->orderByDesc('created_at')->get();
    ...
    public function userProfileUpdate(Request $request)
    {
        ...
        if($validate->fails())
        {
            flash(translate('Your Email Is Not Valid !'))->error();
            return back();
        }
        $user = Auth::user();
    ...
    public function load_random_products_section(){
        return view('frontend.partials.random_products_section');
    }


    public function load_more_random_products_section(){
        return view('frontend.partials.more_random_products');
    }
    ...
    public function product(Request $request, $slug)
    {
        ...
        $discount_end_date = time() + rand(100000,20000);
        $discount_end_date = date('Y/m/d h:i:s' , $discount_end_date);
        if($detailedProduct != null && $detailedProduct->published){
            ...
            if($detailedProduct->digital == 1){
                ...
                return view('frontend.product_details', compact('detailedProduct' , 'discount_end_date'));
            }
        }
        abort(404);
    }
