...
class StateController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.setup_configurations.states.index', compact('states', 'sort_country', 'sort_state'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.setup_configurations.states.edit', compact('countries', 'state'));
    }
