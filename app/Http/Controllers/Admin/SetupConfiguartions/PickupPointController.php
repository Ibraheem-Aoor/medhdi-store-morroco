...
class PickupPointController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.setup_configurations.pickup_point.index', compact('pickup_points','sort_search'));
    }
    ...
    {
        return view('admin.setup_configurations.pickup_point.create');
    }
    ...
    public function edit(Request $request, $id)
    {
        ...
        return view('admin.setup_configurations.pickup_point.edit', compact('pickup_point','lang'));
    }
