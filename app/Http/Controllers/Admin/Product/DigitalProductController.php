...
class DigitalProductController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.product.digital_products.index', compact('products','sort_search'));
    }
    ...
    public function create()
    {
        $categories = Category::where('parent_id', 0)
            ...
            ->get();
        return view('admin.product.digital_products.create', compact('categories'));
    }
    ...
    public function edit(Request $request, $id)
    {
        ...
        $categories = Category::where('parent_id', 0)
            ...
            ->with('childrenCategories')
            ->get();
        return view('admin.product.digital_products.edit', compact('product','lang', 'categories'));
    }
