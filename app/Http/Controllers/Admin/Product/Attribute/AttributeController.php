...
class AttributeController extends Controller
{
    ...
    public function show($id)
    {
        ...
        return view("admin.product.attribute.attribute_value.index", $data);
    }
    ...
    public function edit(Request $request, $id)
    {
        ...
        return view('admin.product.attribute.edit', compact('attribute','lang'));
    }
    ...
    public function colors(Request $request) {
        ...
        return view('admin.product.color.index', compact('colors', 'sort_search'));
    }
