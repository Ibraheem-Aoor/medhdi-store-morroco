...
class CurrencyController extends Controller
{
    ...
    public function currency(Request $request)
    {
        ...
        return view('admin.setup_configurations.currencies.index', compact('currencies', 'active_currencies','sort_search'));
    }
    ...
    {
        return view('admin.setup_configurations.currencies.create');
    }

    public function edit(Request $request)
    {
        $currency = Currency::findOrFail($request->id);
        return view('admin.setup_configurations.currencies.edit', compact('currency'));
    }
