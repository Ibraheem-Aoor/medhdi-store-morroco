...
class LanguageController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.setup_configurations.languages.index', compact('languages'));
    }

    public function create(Request $request)
    {
        return view('admin.setup_configurations.languages.create');
    }
    ...
    public function show(Request $request, $id)
    {
        ...
        return view('admin.setup_configurations.languages.language_view', compact('language','lang_keys','sort_search'));
    }

    public function edit($id)
    {
        $language = Language::findOrFail($id);
        return view('admin.setup_configurations.languages.edit', compact('language'));
    }
    ...
    public function showAppTranlsationView(Request $request, $id)
    {
        ...
        $lang_keys = $lang_keys->paginate(50);
        return view('admin.setup_configurations.languages.app_translation', compact('language','lang_keys','sort_search'));
    }
