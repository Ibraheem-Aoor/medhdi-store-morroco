...
class CustomerPackageController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.customer.customer_packages.index', compact('customer_packages'));
    }
    ...
    {
        return view('admin.customer.customer_packages.create');
    }
    ...
    public function edit(Request $request, $id)
    {
        ...
        return view('admin.customer.customer_packages.edit', compact('customer_package', 'lang'));
    }
