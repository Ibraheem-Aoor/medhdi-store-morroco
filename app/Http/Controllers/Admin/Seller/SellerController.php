...
class SellerController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.sellers.index', compact('shops', 'sort_search', 'approved'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.sellers.edit', compact('shop'));
    }
    ...
    {
        $shop = Shop::findOrFail($id);
        return view('admin.sellers.verification', compact('shop'));
    }
    ...
    public function payment_modal(Request $request)
    {
        ...
        return view('admin.sellers.payment_modal', compact('shop'));
    }

    public function profile_modal(Request $request)
    {
        $shop = Shop::findOrFail($request->id);
        return view('admin.sellers.profile_modal', compact('shop'));
    }
