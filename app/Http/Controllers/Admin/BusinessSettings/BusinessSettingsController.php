...
use App\Http\Requests\HyperPay\UpdateConfigRequest;
...
class BusinessSettingsController extends Controller
{
    public function general_setting(Request $request)
    {
    	...
    	return view('admin.setup_configurations.general_settings');
    }
    ...
    public function activation(Request $request)
    {
        // //CoreComponentRepository::instantiateShopRepository();
        CoreComponentRepository::initializeCache();
    	return view('admin.setup_configurations.activation');
    }
    ...
    public function social_login(Request $request)
    {
        // //CoreComponentRepository::instantiateShopRepository();
        CoreComponentRepository::initializeCache();
        return view('admin.setup_configurations.social_login');
    }
    ...
    public function smtp_settings(Request $request)
    {
        // //CoreComponentRepository::instantiateShopRepository();
        CoreComponentRepository::initializeCache();
        return view('admin.setup_configurations.smtp_settings');
    }

    public function google_analytics(Request $request)
    {
        // CoreComponent/Repository::instantiateShopRepository();
        CoreComponentRepository::initializeCache();
        return view('admin.setup_configurations.google_configuration.google_analytics');
    }
    ...
    public function google_recaptcha(Request $request)
    {
        //CoreComponentRepository::instantiateShopRepository();
        CoreComponentRepository::initializeCache();
        return view('admin.setup_configurations.google_configuration.google_recaptcha');
    }

    public function google_map(Request $request) {
        //CoreComponentRepository::instantiateShopRepository();
        CoreComponentRepository::initializeCache();
        return view('admin.setup_configurations.google_configuration.google_map');
    }

    public function google_firebase(Request $request) {
        //CoreComponentRepository::instantiateShopRepository();
        CoreComponentRepository::initializeCache();
        return view('admin.setup_configurations.google_configuration.google_firebase');
    }
    ...
    public function facebook_chat(Request $request)
    {
        //CoreComponentRepository::instantiateShopRepository();
        CoreComponentRepository::initializeCache();
        return view('admin.setup_configurations.facebook_chat');
    }
    ...
    public function facebook_comment(Request $request)
    {
        //CoreComponentRepository::instantiateShopRepository();
        CoreComponentRepository::initializeCache();
        return view('admin.setup_configurations.facebook_configuration.facebook_comment');
    }
    ...
    public function payment_method(Request $request)
    {
        //CoreComponentRepository::instantiateShopRepository();
        CoreComponentRepository::initializeCache();
        return view('admin.setup_configurations.payment_method');
    }
    ...
    public function file_system(Request $request)
    {
        //CoreComponentRepository::instantiateShopRepository();
        CoreComponentRepository::initializeCache();
        return view('admin.setup_configurations.file_system');
    }
    ...
    public function update(Request $request)
    {
        foreach ($request->types as $key => $type) {
            ...
            if($type == 'timezone'){
                ...
                if(gettype($type) == 'array'){
                    ...
                    if($request->has('appLang'))
                        $business_settings = BusinessSetting::where([['type', $type ] , ['lang' , $request->appLang]])->first();
                    else
                        $business_settings = BusinessSetting::where('type', $type)->first();


                    // return dd($business_settings);
                }
                ...
                if($business_settings!=null){
                    ...
                    $business_settings->lang = $request->appLang ?? $lang;
                    $business_settings->save();
                }
                else{
                    $business_settings = new BusinessSetting;
        ...
        if($request->has('header_menu_labels'))
        {
            $this->insertHeaderManueLabelsTranslated($request);
        }
    ...
    /**
     * insert the header menu lables according the the selected lang
     */
    public function insertHeaderManueLabelsTranslated($request)
    {
        $lables = BusinessSetting::where('type', 'header_menu_labels')->where('lang',$request->lang)->first();
        $lables->value =  json_encode($request->header_menu_labels , JSON_UNESCAPED_UNICODE);
        $lables->save();
    }
    ...
    public function shipping_configuration(Request $request){
        return view('admin.setup_configurations.shipping_configuration.index');
    }
    ...
    public function order_configuration(){
        return view('admin.setup_configurations.order_configuration.index');
    }
    ...
    {
        return view('admin.setup_configurations.payment_configuration.index');
    }
    public function payment_configuration_update(UpdateConfigRequest $reqeust)
    {
        $this->overWriteEnvFile('HYPER_PAY_KEY' , $reqeust->hyper_key);
        $this->overWriteEnvFile('HYPER_PAY_ID' , $reqeust->hyper_id);
        $this->overWriteEnvFile('HYPER_MADA_ID' , $reqeust->mada_id);
        $this->overWriteEnvFile('HYPER_MADA_KEY' , $reqeust->mada_id);
        flash(translate("Settings updated successfully"))->success();
        return back();
    }


    public function payment_activation()
    {
        return view('admin.setup_configurations.payment_activation.index');
    }
