<?php
namespace App\Http\Controllers\Admin\Marketing\FlashDeals;
...
class FlashDealController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.marketing.flash_deals.index', compact('flash_deals', 'sort_search'));
    }
    ...
    {
        return view('admin.marketing.flash_deals.create');
    }
    ...
    public function edit(Request $request, $id)
    {
        ...
        return view('admin.marketing.flash_deals.edit', compact('flash_deal','lang'));
    }
    ...
    public function product_discount(Request $request){
        ...
        return view('admin.marketing.flash_deals.flash_deal_discount', compact('product_ids'));
    }

    public function product_discount_edit(Request $request){
        $product_ids = $request->product_ids;
        $flash_deal_id = $request->flash_deal_id;
        return view('admin.marketing.flash_deals.flash_deal_discount_edit', compact('product_ids', 'flash_deal_id'));
    }
}
